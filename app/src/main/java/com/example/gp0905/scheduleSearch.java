...
import com.example.gp0905.MainActivity;
...
public class scheduleSearch {
    ...
    public interface MyCallback {
        void onCallback(String value, String title, String st_date, String ed_date, String st_time, String ed_time, int flag,int flag2);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot objSnapshot : snapshot.getChildren()) {
                    ...
                    if (obj.equals(maxKey[0])) {
                        ...
                        mcb.onCallback(maxKey[0], title, st_date, ed_date, st_time, ed_time,flag,0);
                    }
                }
            }
